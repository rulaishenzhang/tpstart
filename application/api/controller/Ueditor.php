...
class Ueditor extends Controller
{
    ...
    private function getList()
    {
        ...
        if (!$this->fun_adm_count($files)) {
            return [
                "state" => "no match file",
                "list"  => [],
                "start" => $start,
                "total" => $this->fun_adm_count($files)
            ];
        }

        /* 获取指定范围的列表 */
        $len = $this->fun_adm_count($files);
    ...
    public function fun_adm_count($array_or_countable,$mode = COUNT_NORMAL){
